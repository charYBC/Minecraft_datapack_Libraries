...
execute if score @s windcharge_motion.playermotion.x matches 10000.. run scoreboard players set @s windcharge_motion.playermotion.x 10000
execute if score @s windcharge_motion.playermotion.y matches 10000.. run scoreboard players set @s windcharge_motion.playermotion.y 10000
execute if score @s windcharge_motion.playermotion.z matches 10000.. run scoreboard players set @s windcharge_motion.playermotion.z 10000
