...
execute store result storage windcharge_motion:storage position.x_rotate double 0.00001 run scoreboard players get @s windcharge_motion.x_facing
execute store result storage windcharge_motion:storage position.y_rotate double 0.00001 run scoreboard players get @s windcharge_motion.y_facing
