...
execute unless score adjust custom_enchantments.BookShelfAround matches 1 if score @s random_prob <= target random_prob run function custom_enchantments:grant_enchantments/random_enchant_level with storage custom_enchant:storage Temp
...
execute if score @s random_prob <= target random_prob run item modify entity @s player.cursor custom_enchantments:set_glint