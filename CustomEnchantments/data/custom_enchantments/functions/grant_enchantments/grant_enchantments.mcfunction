...
execute if score @s custom_enchantments.random_prob <= target custom_enchantments.random_prob at @s as @e[tag=copy_data,type=chest_minecart] if score @p custom_enchantments.id = @s custom_enchantments.id run function custom_enchantments:grant_enchantments/set_glint