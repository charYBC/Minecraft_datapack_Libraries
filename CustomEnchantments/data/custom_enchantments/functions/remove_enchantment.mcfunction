...
execute at @s as @e[tag=copy_data,type=chest_minecart] if score @p custom_enchantments.id = @s custom_enchantments.id run function custom_enchantments:remove_glint
