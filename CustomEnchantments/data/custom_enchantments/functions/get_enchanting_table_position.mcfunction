scoreboard players add @s custom_enchantments.enchanting_table_distance 1
execute if score @s custom_enchantments.enchanting_table_distance matches 24 run return 0
