summon minecraft:slime ~ ~ ~ {NoAI:true,Tags:["windcharge_motion.timerlauncher","windcharge_motion"],DeathLootTable:"",HasVisualFire:0b,PersistenceRequired:1b,Health:100f,Attributes:[{Name:generic.max_health,Base:100}],Silent:1b}
